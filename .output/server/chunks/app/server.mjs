import { version as version$1, hasInjectionContext, getCurrentInstance, inject, ref, watchEffect, watch, toRef, onServerPrefetch, useSSRContext, createApp, reactive, unref, provide, onErrorCaptured, createVNode, resolveDynamicComponent, shallowRef, computed, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, withCtx, mergeProps, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d1b7abd4.mjs').then((m) => m.default || m)
  }
];
...
const NuxtApollo = {
  ...
  clients: { "default": { "httpEndpoint": "https://rickandmortyapi.com/graphql", "authType": "Bearer", "authHeader": "Authorization", "tokenName": "apollo:default.token", "tokenStorage": "cookie" } }
};
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-fbbc437c.mjs').then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-8ece19a0.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-0bc09abe.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-70024937.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
...
export { _export_sfc as _, useAsyncQuery as a, useRouter as b, createError as c, entry$1 as default, navigateTo as n, useHead as u };
